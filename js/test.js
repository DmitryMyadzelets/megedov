...
},{"./ready":2,"./test.json":3}],2:[function(require,module,exports){
...
module.exports={
    ...
    "questions":{
        "1":{
            "J":"Вы постоянны в своих убеждениях. Вы принимаете решения и всегда стараетесь следовать им. Ваша работоспособность постоянна, без длительных спадов и всплесков. Считаете, что план действий и набор чётких правил лежат в основе стабильности, успеха и спокойствия в жизни. Вы довольно сильно переживаете, когда кто-то или что-то срывает ваш заранее продуманный распорядок дня, и вы вынуждены планировать день заново.",
            "P":"Вы, в основном, действуете по ситуации, а работоспособность зависит от настроения. Бывает, что откладываете дела до последнего, но в конце совершаете рывок и навёрстываете упущенное. Если вы сталкиваетесь с рутиной, необходимостью ежедневно следовать строгому плану или графику, то вас это довольно скоро начинает угнетать."
        },
        "2":{
            "T":"Обосновывая свою точку зрения, вы предпочитаете спокойно оперировать объективными фактами и цифрами, считая что ваши чувства и эмоциональное отношение других вторичны. Вы обычно видите последовательность шагов в каком-либо деле, склонны структурировать и упорядочивать. Замечаете нестыковки в разговорах и текстах, и зачастую указываете на это.",
            "F":"Вас интересуют чувства, настроения, переживания и отношения между людьми, вы охотно участвуете в обсуждении и решении их личных проблем. Стараетесь улучшить взаимопонимание, так как не выносите разногласий и обид в своем окружении. Вам нравится создавать приятную атмосферу общения. Считаете, что интонация важна и может сказать больше чем сами слова."
        },
        "3":{
            "S":"Вы отлично разбираетесь в своих физических потребностях и ощущениях, и зачастую догадываетесь о том, что ощущают другие. Вам обычно не безразлично, кто на чьей территории находится, кто гость, а кто хозяин. Вы внимательны к деталям, охотно уточняете сказанное и проверяете сделанное.",
            "N":"Вы отлично чувствуете что настал момент, либо ещё рано, для какого-либо действия. Вы хорошо видите возможности и способности других людей, легко улавливаете суть сказанного собеседником, не нуждаясь в уточнениях."
        },
        "4":{
            "I":"Долгое нахождение в центре внимания вас, скорее всего, утомит. Вы долго устанавливаете хорошие отношения с людьми, вам проще поддерживать существующие чем искать новые. Вам ясен свой внутренний мир, но бывает сложно понять поступки других.",
            "E":"Вы можете находиться в центре внимания и активно общаться, не утомляясь. Вам зачастую проще понять и описать других, чем себя. Любите заводить новые знакомства. Считаете, что общественное выше личного."
        }
    },
    "lables":{
        "J":"Рациональность",
