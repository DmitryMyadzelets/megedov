...
module.exports={
    ...
    "questions":{
        ...
        "3":{
            "S":"Вы &mdash; реалист и практик, любите скорее действовать, чем размышлять, многие вещи предпочитаете делать своими руками, не доверяя этого другим. Охотно занимаетесь бытовыми вопросами или практическими делами. Ваши высказывания обычно лаконичны и конкретны, без намеков, подтекстов и иносказаний. С острожностью относитесь к не проверенным практикой идеям и подходам в работе, больше доверяя фактам и опыту. Внимательны к деталям, охотно уточняете сказанное и проверяете сделанное, как вами самими, так и другими. Вам больше свойственны: опытность и практичность, реалистичность, мотивация выгодными делами, упор на факты и проверенные методы.",
